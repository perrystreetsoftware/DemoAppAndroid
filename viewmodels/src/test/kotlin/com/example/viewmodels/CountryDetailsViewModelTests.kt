...
class CountryDetailsViewModelTests: KoinTest {
    ...
    private val country = CountryDomainModel(countryName = "Uganda", regionCode = "ug")
    ...
    inner class OnAppear {
        ...
        lateinit var detailsTestObserver: TestObserver<CountryDetailsDomainModel>
        ...
        fun `then it has not loaded`() {
            detailsTestObserver.values().last().shouldBeEqualTo(CountryDetailsDomainModel.EMPTY)
        }
        ...
        inner class Advance {
            ...
            fun `then it has loaded values`() {
                detailsTestObserver.values().last().shouldBeEqualTo(CountryDetailsDomainModel(regionCode = "YE", countryName = "Yemen", detailsText = "Article 264"))
            }
        }
    }
}