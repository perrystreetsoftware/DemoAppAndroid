...
import com.example.uicomponents.models.DialogAction
...
import com.example.uicomponents.models.ToastUiState
...
class CountryListErrorFloatingAlertFactory(
    ...
    private fun CountryListError.titleAndMessage(): Pair<Int, List<Int>> = when (this) {
        ...
        CountryListError.Other -> R.string.other_error_title to listOf(
            R.string.other_error_message1,
            R.string.other_error_message2
        )
...
fun CountryListError.asFloatingAlert(viewModel: CountryListViewModel, onAboutSelected: () -> Unit) =
    CountryListErrorFloatingAlertFactory(viewModel, onAboutSelected).asFloatingAlert(this)
